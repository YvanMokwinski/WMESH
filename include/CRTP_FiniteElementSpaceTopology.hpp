...
template <class _derivedClass> struct Traits_CRTP_FiniteElementSpaceTopology
{
public: static constexpr bool IsMixed = false;
public: static constexpr DimensionType::enum_t Dimension = DimensionType::Node;
};

template <typename _derivedClass> class CRTP_FiniteElementSpaceTopology
{
  //!
  //! @brief Constant static cast of the derived class.
  //!  
...
public: using cellidx_t = int_t;
  ...
  //! @brief Associated traits of the class.
  //!  
private: using traits_t = Traits_CRTP_FiniteElementSpaceTopology<_derivedClass>;
...
public: using node_t 	= entity_t<DimensionType::Node>;
  ...
  //!  
public: CRTP_FiniteElementSpaceTopology(const CRTP_FiniteElementSpaceTopology<_derivedClass>&) = delete;

  //!
  //! @brief Protected default constructor.
  //!  
protected: inline CRTP_FiniteElementSpaceTopology(){};  
...
template<> class FiniteElementSpaceTopology<DimensionType::Volume>
  : public CRTP_FiniteElementSpaceTopology<FiniteElementSpaceTopology<DimensionType::Volume> >
{
  
protected: using this_t 	= FiniteElementSpaceTopology<DimensionType::Volume>;
protected: using traits_t 	= CRTP_FiniteElementSpaceTopology< this_t >::traits_t;  
...
public: FiniteElementSpaceTopology(Input::Medit&inputMedit) noexcept
  {
...
public: inline ~FiniteElementSpaceTopology()
  {
...
using FiniteElementSpaceTopology3D = FiniteElementSpaceTopology<DimensionType::Volume>;
...
template <>
inline unsigned int FiniteElementSpaceTopology3D::GetEntityToEntities<DimensionType::Volume,DimensionType::Node>(const FiniteElementSpaceTopology3D::entity_t<DimensionType::Volume>& sourceEntity_,
														       FiniteElementSpaceTopology3D::entity_t<DimensionType::Node> targetEntities_[]) const noexcept
{
  //
  // Get the cell
  //
...
template <>
inline RangeMeshEntities<int_t> FiniteElementSpaceTopology3D::GetEntities<DimensionType::Volume>(const VolumeType::enum_t entityKind_) const noexcept
{
  return RangeMeshEntities<int_t>(0,m_numCellsPerKind[entityKind_]);
};

template <>
inline RangeMeshEntities<int_t> FiniteElementSpaceTopology3D::GetEntities<DimensionType::Node>(const NodeType::enum_t entityKind_) const noexcept
{
